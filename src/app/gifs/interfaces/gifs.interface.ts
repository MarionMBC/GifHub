// To parse this data:
//
//   import { Convert, SearchGifsRes } from "./file";
//
//   const searchGifsRes = Convert.toSearchGifsRes(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsRes {
  data:       Gif[];
...
export class Convert {
  public static toSearchGifsRes(json: string): SearchGifsRes {
      return cast(JSON.parse(json), r("SearchGifsRes"));
  }

  public static searchGifsResToJson(value: SearchGifsRes): string {
      return JSON.stringify(uncast(value, r("SearchGifsRes")), null, 2);
  }
}
